...
public class ProProductController {
    ...
    public ResponseEntity<Void> deleteProduct(@PathVariable("shopId") String shopId, @PathVariable("productId") String productId) {
        proProductService.delete(shopId, productId);
